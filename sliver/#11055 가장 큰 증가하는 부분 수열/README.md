# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/9.svg" class="solvedac-tier"> [가장 큰 증가하는 부분 수열](https://www.acmicpc.net/problem/11055) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|93783714| hellosj2000|맞았습니다!! 맞았습니다!!|14532KB|120ms|Java 11|978B|
